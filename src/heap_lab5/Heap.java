...
element.
    ...
    public T poll() {
    	...
    	if(this.container.size() == 0){
     	   ...
     	   T objFirst = this.container.get(0);
     	   T objLast = this.container.get(this.container.size()-1);
     	   this.container.set(0, objLast);
...
parent.
    ...
    private void heapifyUp() {
    	...
    	while(hasParent(pos)){
    		if(this.container.get(this.getParentIndex(pos)).compareTo(this.container.get(pos)) > 0){
